...
The brain's balance system combines three input streams:

1. **Vestibular system** — semicircular canals and otoliths in the inner
   ear (head tilt, turn, speed).
2. **Visual system** — sight.
3. **Proprioceptive system** — position/pressure/movement signals from
   legs, feet and body.

In PPPD, after a triggering event the brain **stays in "high-risk" mode**
instead of returning to normal:

- The person worries about falling and pays extra attention to balance.
- The brain stays on alert and relies more on **visual input**.
...
- Vestibular neuritis
- BPPV
- Isolated otolith dysfunction (iOD)
- Vestibular migraine
...
- Poor vision
- Weak muscles, poor coordination
...
- Light-headedness (woozy, about to pass out)
- Mild dissociation ("spaced out", floating)

Symptoms worsen with:

- Standing or sitting upright
- Seeing movement: scrolling, TV, traffic, crowds
- Complex patterns: busy carpets, wallpaper, supermarket aisles
- Walking or riding in a car
- Fatigue, or focusing on symptoms

Related problems that develop: neck stiffness, gait problems, fatigue,
fear of falling, anxiety/avoidance of triggers.

**Visually induced dizziness** (an umbrella term, often part of PPPD) adds:
...
- No single specific test; diagnosis uses **clinical criteria**, not
  exclusion.
- Diagnosed by primary care doctors or specialists (neurologist,
  otolaryngologist, otologist, psychiatrist).
- Tests may include: physical exam, vestibular function tests, balance
  tests, blood tests, CT/MRI imaging.

**Clinical criteria (all must be met):**

1. Dizziness, unsteadiness or non-spinning vertigo on **most days for ≥3
   months**, lasting hours, waxing/waning.
2. Symptoms worsen with **upright posture**, **motion in any direction**,
   and **moving/complex visual stimuli**.
3. Triggered by events causing vertigo, unsteadiness, dizziness or
   balance problems (acute, episodic or chronic vestibular syndromes,
   other illnesses, or psychological distress).
4. Significant distress or functional impairment.
5. Not better explained by another disease.
